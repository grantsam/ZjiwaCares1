          ...
          <div class="row align-items-center">
            <div class="col-md-8">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Deskripsi"
                  required></textarea>
              </div>
            </div>
                ...
                <table class="table table-striped align-middle">
                  ...
                  <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><img src="<?= htmlspecialchars($row['foto']) ?>" alt="Profil" class="img-thumbnail"
                            width="100"></td>
